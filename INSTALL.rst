========================================================================
** pycommand ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **pycommand** in your system. 
...
To install **pycommand** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/pycommand.git#egg=pycommand

The above command will install the latest development release of **pycommand**.
